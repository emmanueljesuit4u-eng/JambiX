...
export const TermsModal: React.FC<TermsModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="w-full sm:max-w-lg bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl border border-slate-200 flex flex-col max-h-[88vh] sm:max-h-[80vh] overflow-hidden animate-in fade-in zoom-in-95 duration-150"
      >
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 bg-slate-50/50">
          <div className="flex items-center gap-2">
            ...
            <h3 id="terms-modal-title" className="text-base font-bold text-slate-900">
        ...
        {/* Tab Switcher */}
        <div className="flex p-1.5 mx-5 mt-4 bg-slate-100 rounded-xl gap-1">
          <button
            type="button"
        ...
        <div className="p-5 overflow-y-auto space-y-4 text-xs leading-relaxed text-slate-600">
          {activeTab === 'terms' ? (
            <>
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm mb-1">2. Account Responsibility</h4>
                <p>
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm mb-1">3. Academic Integrity & CBT Practice</h4>
                <p>
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm mb-1">4. Service Availability</h4>
                <p>
            ...
            <>
              <div className="p-3 bg-teal-50/70 border border-teal-100 rounded-xl text-teal-900 text-xs">
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm mb-1">2. How We Protect Your Data</h4>
                <p>
              ...
              <div>
                <h4 className="font-bold text-slate-900 text-sm mb-1">3. SMS & Email Notifications</h4>
                <p>
