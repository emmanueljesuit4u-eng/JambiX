      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200/80 p-6 sm:p-7">
        {!isSubmitted ? (
          ...
          <div className="text-center py-2 space-y-4 animate-in fade-in">
            ...
            <div className="p-3 bg-slate-50 border border-slate-200/80 rounded-xl text-left text-xs text-slate-600 space-y-1">
              <p className="font-medium text-slate-800">Can&apos;t find the email?</p>
              ...
              <div className="pt-1">
                <button
                  ...
                  className="text-xs font-semibold text-emerald-700 hover:text-emerald-800 disabled:text-slate-400 disabled:cursor-not-allowed transition-colors"
                >
                  {resendCooldown > 0
        ...
        <div className="mt-6 pt-5 border-t border-slate-100 text-center">
          <button
            ...
            className="inline-flex items-center justify-center gap-2 text-xs font-bold text-slate-700 hover:text-emerald-700 transition-colors py-1 px-3 rounded-lg hover:bg-slate-50 cursor-pointer"
          >
